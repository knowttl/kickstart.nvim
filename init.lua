...
-- NOTE: The following are custom options
vim.opt.tabstop = 4
...
-- Previous Pane Switching Config (Custom)
...
-- NOTE: Custom Key Maps Additional Sane Key Maps (Custom)
...
-- COPY and Pasting KEYBOAD Mapping
-- -- greatest remap ever
...
-- Autocmd to set up msbuild for relevant file types
vim.api.nvim_create_autocmd({ 'FileType' }, {
    pattern = { 'cs', 'vb', 'csproj', 'sln' },
    callback = function()
        -- Use the built-in compiler script
        vim.cmd [[compiler msbuild]]
        -- Set the make program
        vim.opt.makeprg = 'msbuild.exe'
        -- Ensure output is captured in the quickfix list
